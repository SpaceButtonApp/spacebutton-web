            ...
            <div className="grid grid-cols-2 lg:grid-cols-5 gap-8 mb-8">
              <div className="col-span-2 lg:col-span-1">
                ...
                <div className="flex gap-3">
                  ...
                  <a href="https://www.tiktok.com/@spacebutton.net?_r=1&_t=ZS-97DJIIiVnui" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-secondary rounded-full flex items-center justify-center hover:bg-primary hover:text-primary-foreground transition-colors" title="TikTok">
                    <img src="/icons/tiktok.png" alt="TikTok" className="w-5 h-5 dark:invert" />
                  </a>
                  ...
                  <a href="https://wa.me/+2349034466046" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-secondary rounded-full flex items-center justify-center hover:bg-primary hover:text-primary-foreground transition-colors" title="WhatsApp">
